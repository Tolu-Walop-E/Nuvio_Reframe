...
private fun dtoToViewPack(parsed: ViewPackDto, includeScreenPacks: Boolean): ViewPack {
    ...
    return ViewPack(
        ...
        collectionTitleScale = normalizePackCardScale(parsed.collectionTitleScale),
...
private fun viewPackToDto(pack: ViewPack, includeScreenPacks: Boolean): ViewPackDto {
    ...
    return ViewPackDto(
        ...
        collectionTitleScale = pack.collectionTitleScale,
...
private data class ViewPackDto(
    ...
    val collectionTitleScale: Float? = null,
